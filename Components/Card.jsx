...
const Card = ({ allcampaign, setOpenModel, setDonate, title }) => {
  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <p className="py-5 text-2xl font-bold leading-5">{title}</p>
      <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
        {allcampaign?.map((campaign, i) => (
          ...
          >
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1H-HlgiG8Faak0iXboThZLResI0-yV6k2s-nKMXTC_QXdTZw9CzuHaWHpl3zamTQ35yk&usqp=CAU
                   auto=compress&cs=tinyrgb&dpr=3&amp;h=750&amp;w=1260"
